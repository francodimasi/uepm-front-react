...
export const PlayVideoModal: React.FC<PlayVideoProps> = ({ title, videoLink, open, onClose }) => {
  return (
            ...
            >
              ...
              <Dialog.Panel className="relative p-4 transform overflow-hidden rounded-lg bg-light text-left shadow-2xl transition-all sm:my-24 sm:w-full sm:min-h-[400px] max-w-3xl">
                <div className="text-center">
                  ...
                  <iframe src={videoLink} allowFullScreen className='w-full h-full sm:min-h-[400px]' />
                </div>
              </Dialog.Panel>
            </Transition.Child>
        </div>
