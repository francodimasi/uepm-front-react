...
export const Recommended: React.FC<RecommendedProps> = ({ posts, tag }) => {
  ...
  return (
    <div className="w-full flex-col gap-8 inline-flex pt-2">
      <div className="flex justify-between items-center self-stretch">
        ...
        <Link href={`/en/blog?tag=${tag}`}>
          <div className="text-dark text-base font-bold font-['DMSans'] leading-none">
            Ver más →
          </div>
        </Link>
      </div>
            ...
            >
              ...
              <div className="col-span-2 col-start-2 lg:flex lg:flex-col self-stretch gap-2">
                ...
                <Link href={`/en/blog/article/${post.slug}`}>
                  <div className="overflow-ellipsis self-stretch text-dark text-base font-semibold font-['Lexend'] leading-normal">
                    {post.title.rendered}
                  </div>
                </Link>
