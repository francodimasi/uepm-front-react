...
export const Interesting: React.FC<InterestingProps> = ({ blogPost }) => {
  ...
  return (
    <div className="pb-6 border-b border-gray-medium flex-col gap-8 inline-flex">
      <div className="text-primary text-2xl font-semibold font-['Lexend'] leading-7">
        Te podría interesar
      </div>
      ...
      <div className="self-stretch flex-col gap-2 flex">
        <div className="self-stretch text-dark text-xs font-normal font-['DMSans'] uppercase leading-none tracking-tight">
          {blogPost.tags}
        </div>
        {/* TODO: review locale in link */}
        <Link href={`/en/blog/article/${blogPost.slug}`}>
          <div className="self-stretch text-dark text-base font-semibold font-['Lexend'] leading-normal">
            {blogPost.title.rendered}
          </div>
        </Link>
        <div className="self-stretch text-dark text-xs font-normal font-['DMSans'] uppercase leading-normal">
          {blogPost.date}
        </div>
      </div>
    </div>
