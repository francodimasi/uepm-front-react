        ...
        >
          {topics.map((topic) => (
            <Tag
              ...
              className="my-1.5 sm:my-2 mx-0.5 sm:mx-0 px-0.5 sm:px-2 py-0.5 sm:py-0 text-start border-l-1 border-solid border-l-gray-medium leading-none text-sm capitalize cursor-pointer"
            />
          ))}
        </div>
      </div>
