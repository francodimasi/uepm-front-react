  ...
  (
    ...
    return (
      <textarea
        ...
        id={name}
        className={clsx(
          'block w-full border-b-1 border-gray-medium pe-4 py-4 text-dark placeholder:text-gray-dark focus:border-primary-dark text-xl leading-6 cursor-text outline-none',
          {
